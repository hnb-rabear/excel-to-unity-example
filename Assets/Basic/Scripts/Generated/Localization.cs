namespace Excel2Unity.Basic
{
	...
	public static class Localization
	{
		...
		{
			NONE = -1,
			message_1 = 0, message_2, message_3, message_4, message_5, content_1, content_2, content_3, content_4, content_5, title_1, title_2, title_3, title_4, title_5, title_6, whatever_msg, hero_name_1, hero_name_2, hero_name_3, hero_name_4, hero_name_5, UI_DAY_1, UI_DAY_2, UI_DAY_3, UI_DAY_4, UI_DAY_5, UI_TODAY, UI_TAP_TO_COLLECT, UI_FREE_GIFT, UI_REFRESH_IN, UI_FREE_GIFT_EVERYDAY, UI_WAIT_TIME_MINUS_30M, UI_UPGRADE_BARN, UI_UPGRADE, UI_BUY, UI_GO_TO_SHOP, UI_CONFIRM, UI_CANCEL, UI_WARNING, UI_BARN_UPGRADE, UI_FINISH_BUILDING, UI_FINISH, UI_COMPLETE, UI_NOT_ENOUGH_COIN, UI_NOT_ENOUGH_CASH, UI_TAP_TO_CLOSE, UI_SEND, UI_UNLOCK_AT_LEVEL_X, UI_REQUIRED_LEVEL_X, UI_REQUIRED_CITY_LEVEL_X, UI_MISSION_COMPLETED,
		}
		public const int
			message_1 = 0, message_2 = 1, message_3 = 2, message_4 = 3, message_5 = 4, content_1 = 5, content_2 = 6, content_3 = 7, content_4 = 8, content_5 = 9, title_1 = 10, title_2 = 11, title_3 = 12, title_4 = 13, title_5 = 14, title_6 = 15, whatever_msg = 16, hero_name_1 = 17, hero_name_2 = 18, hero_name_3 = 19, hero_name_4 = 20, hero_name_5 = 21, UI_DAY_1 = 22, UI_DAY_2 = 23, UI_DAY_3 = 24, UI_DAY_4 = 25, UI_DAY_5 = 26, UI_TODAY = 27, UI_TAP_TO_COLLECT = 28, UI_FREE_GIFT = 29, UI_REFRESH_IN = 30, UI_FREE_GIFT_EVERYDAY = 31, UI_WAIT_TIME_MINUS_30M = 32, UI_UPGRADE_BARN = 33, UI_UPGRADE = 34, UI_BUY = 35, UI_GO_TO_SHOP = 36, UI_CONFIRM = 37, UI_CANCEL = 38, UI_WARNING = 39, UI_BARN_UPGRADE = 40, UI_FINISH_BUILDING = 41, UI_FINISH = 42, UI_COMPLETE = 43, UI_NOT_ENOUGH_COIN = 44, UI_NOT_ENOUGH_CASH = 45, UI_TAP_TO_CLOSE = 46, UI_SEND = 47, UI_UNLOCK_AT_LEVEL_X = 48, UI_REQUIRED_LEVEL_X = 49, UI_REQUIRED_CITY_LEVEL_X = 50, UI_MISSION_COMPLETED = 51;
		public static readonly string[] idString = new string[]
		{
			"message_1", "message_2", "message_3", "message_4", "message_5", "content_1", "content_2", "content_3", "content_4", "content_5", "title_1", "title_2", "title_3", "title_4", "title_5", "title_6", "whatever_msg", "hero_name_1", "hero_name_2", "hero_name_3", "hero_name_4", "hero_name_5", "UI_DAY_1", "UI_DAY_2", "UI_DAY_3", "UI_DAY_4", "UI_DAY_5", "UI_TODAY", "UI_TAP_TO_COLLECT", "UI_FREE_GIFT", "UI_REFRESH_IN", "UI_FREE_GIFT_EVERYDAY", "UI_WAIT_TIME_MINUS_30M", "UI_UPGRADE_BARN", "UI_UPGRADE", "UI_BUY", "UI_GO_TO_SHOP", "UI_CONFIRM", "UI_CANCEL", "UI_WARNING", "UI_BARN_UPGRADE", "UI_FINISH_BUILDING", "UI_FINISH", "UI_COMPLETE", "UI_NOT_ENOUGH_COIN", "UI_NOT_ENOUGH_CASH", "UI_TAP_TO_CLOSE", "UI_SEND", "UI_UNLOCK_AT_LEVEL_X", "UI_REQUIRED_LEVEL_X", "UI_REQUIRED_CITY_LEVEL_X", "UI_MISSION_COMPLETED",
		};
